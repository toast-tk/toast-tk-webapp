...
export declare class StateService {
    ...
    $current: State;
    private rejectFactory;
    constructor($view: ViewService, $urlRouter: UrlRouter, $transitions: TransitionService, stateRegistry: StateRegistry, stateProvider: StateProvider, globals: UIRouterGlobals);
    /**
     ...
     * the result returned.
     */
    private _handleInvalidTargetState(fromPath, $to$);
    /**
     * @ngdoc function
